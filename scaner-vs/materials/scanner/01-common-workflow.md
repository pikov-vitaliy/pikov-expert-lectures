...
Используйте формат, предлагаемый фактической версией; HTML достаточно для базового задания. Если интерфейс предлагает скрыть найденные пароли, включите эту настройку и все равно проверьте отчет вручную перед передачей.
