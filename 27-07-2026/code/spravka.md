...
Инструменты на машине преподавателя: `ruff 0.15.16`, `pytest 9.1.1`, `bandit 1.9.4` — установлены и проверены. Bandit на Windows запускать с ключом `-X utf8`: `py -X utf8 -m bandit step3_defect.py`.
