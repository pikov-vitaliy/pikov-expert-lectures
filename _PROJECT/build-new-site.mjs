...
<script>try{var theme=localStorage.getItem('pikov-new-theme');if(theme==='dark'||theme==='light')document.documentElement.dataset.theme=theme}catch(e){}</script><link rel="stylesheet" href="${asset('styles.css')}"><script src="${asset('site.js')}" defer></script>
