...
function Get-RootReleaseFiles([string]$RootPath) {
  $rootNames = @(
    ...
    'new/ru/about/index.html',
    'new/assets/styles.css',
    'new/assets/site.js',
    'new/assets/illustrations/rbpo.webp',
    'new/assets/illustrations/os.webp',
    'new/assets/illustrations/reg.webp',
    'new/assets/illustrations/offense.webp',
