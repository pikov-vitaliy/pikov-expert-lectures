...
function buildRussian(english) {
    ...
    "@graph": [
      {
        ...
        "alternateName": ["Виталий Пиков", "Vitaly Pikov", "Vitaliy Pikov"],
  ...
  const replacements = [
    ...
    ["<meta property=\"og:title\" content=\"Vitaly Pikov — secure software development, DevSecOps and AppSec expert\">", "<meta property=\"og:title\" content=\"Виталий Пиков — эксперт по безопасной разработке ПО, DevSecOps и AppSec\">", "OpenGraph title"],
    ...
    ["<meta property=\"og:image:alt\" content=\"Vitaly Pikov — portrait\">", "<meta property=\"og:image:alt\" content=\"Пиков Виталий Александрович — фото\">", "OpenGraph image alt"],
    ["<meta property=\"profile:first_name\" content=\"Vitaly\">", "<meta property=\"profile:first_name\" content=\"Виталий\">", "profile first name"],
    ["<meta property=\"profile:last_name\" content=\"Pikov\">", "<meta property=\"profile:last_name\" content=\"Пиков\">", "profile last name"],
    ["<meta name=\"twitter:title\" content=\"Vitaly Pikov — secure software development, DevSecOps and AppSec expert\">", "<meta name=\"twitter:title\" content=\"Виталий Пиков — эксперт по безопасной разработке ПО, DevSecOps и AppSec\">", "Twitter title"],
    ...
    ["<meta name=\"twitter:image:alt\" content=\"Vitaly Pikov — portrait\">", "<meta name=\"twitter:image:alt\" content=\"Пиков Виталий Александрович — фото\">", "Twitter image alt"],
    ...
    ["alt=\"Vitaly Pikov — portrait\"", "alt=\"Пиков Виталий Александрович — фото\"", "portrait alt"],
...
function buildRussianCourseMap(english) {
  const replacements = [
    ["<html lang=\"en\" data-lang=\"en\">", "<html lang=\"ru\" data-lang=\"ru\">", "document language"],
    ["<title>Teaching map of the courses — Vitaly Pikov</title>", "<title>Преподавательская карта курсов — Виталий Пиков</title>", "title"],
    ["<meta name=\"author\" content=\"Vitaly Pikov\">", "<meta name=\"author\" content=\"Пиков Виталий Александрович\">", "author"],
    ...
    ["<meta property=\"og:description\" content=\"Five specialisations and verifiable learning outcomes across the whole network of Vitaly Pikov's materials.\">", "<meta property=\"og:description\" content=\"Пять направлений и проверяемые учебные результаты для всей сети материалов Виталия Пикова.\">", "OpenGraph description"],
    ...
    ["<meta name=\"twitter:description\" content=\"Five specialisations and verifiable learning outcomes across the whole network of Vitaly Pikov's materials.\">", "<meta name=\"twitter:description\" content=\"Пять направлений и проверяемые учебные результаты для всей сети материалов Виталия Пикова.\">", "Twitter description"],
