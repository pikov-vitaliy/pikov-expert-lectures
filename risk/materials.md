...
Документ поддерживается как **evergreen-материал**. Перед использованием сверяйте статус и редакцию каждого нормативного акта по указанной официальной ссылке. В перечне учтены ключевые изменения 2025–2026 годов, в том числе:
...
**Изменения 2026 года, включённые в текущую редакцию:**
...
> **Внимание лектора.** Перед занятием проверьте фактический статус проекта изменений приказов № 235/239 по официальной публикации. Если он ещё не вступил в силу, обозначьте плановую дату 01.09.2026 как горизонт планирования, а не как действующее требование.
...
## 1.16. Оценка рисков по NIST SP 800-30 Rev. 1

[NIST SP 800-30 Rev. 1 «Guide for Conducting Risk Assessments»](https://csrc.nist.gov/pubs/sp/800/30/r1/final) заменил редакцию 2002 года «Risk Management Guide for Information Technology Systems». Актуальный процесс состоит из трёх взаимосвязанных стадий:

1. **Prepare for the assessment** — определить цель, scope, допущения и ограничения, источники информации, модель риска, аналитический подход, роли и результаты, которые должны получить лица, принимающие решения.
2. **Conduct the assessment** — идентифицировать источники и события угроз, уязвимости и предрасполагающие условия; определить вероятность, воздействие и итоговый риск.
3. **Maintain the assessment** — отслеживать изменения факторов риска, обновлять отдельные компоненты либо оценку целиком и сообщать актуальные результаты заинтересованным сторонам.

### Историческая справка: редакция 2002 года

Приведённая ниже схема «девять стадий оценки + семь шагов снижения» используется в части учебной литературы и полезна для сопоставления терминов. Она относится к **отозванной редакции SP 800-30 2002 года** и не является текущей моделью NIST.

#### Девять стадий оценки рисков ИБ для ИС
...
#### Семь стадий снижения рисков ИБ
...
12. Назовите три стадии NIST SP 800-30 Rev. 1 и основные задачи стадии Conduct.
...
## 2.3. Нормативная база КИИ: ключевые документы и контроль версий
...
Ниже приведена **авторская семиступенчатая учебная composite-модель**: она объединяет ГОСТ Р 59712, практики SANS и рекомендации [NIST SP 800-61r3](https://csrc.nist.gov/pubs/sp/800/61/r3/final), который встраивает incident response в **NIST CSF 2.0**. Это не официальный семиступенчатый lifecycle NIST.
...
**Entropy injection** — внесение случайности в работу систем (рандомизация памяти, конфигурационных параметров), которое затрудняет повторяемость атаки. Эффект зависит от модели угроз, исходной конфигурации и измеряемой метрики; универсальный процент эффективности без описания эксперимента использовать нельзя.
...
- **[NIST SP 800-61r3](https://csrc.nist.gov/pubs/sp/800/61/r3/final)** «Incident Response Recommendations and Considerations for Cybersecurity Risk Management: A CSF 2.0 Community Profile» — актуальный методический ориентир для встраивания реагирования в NIST CSF 2.0.
...
## Приложение А. Перечень нормативных документов и официальных источников
...
- NIST SP 800-30 Rev. 1, SP 800-37 Rev. 2, SP 800-53 Rev. 5 и SP 800-61 Rev. 3.
- MITRE ATT&CK, D3FEND.
...
10. Приказ ФСТЭК от 11.04.2025 № 117 (редакцию проверять по официальной публикации).
...
16. NIST SP 800-61 Rev. 3 «Incident Response Recommendations and Considerations for Cybersecurity Risk Management: A CSF 2.0 Community Profile».
17. OCTAVE (Operationally Critical Threat, Asset, and Vulnerability Evaluation) — CERT/SEI, Carnegie Mellon University.

### Отраслевые материалы

18. Карантаев В.Г. Технические требования и их реализация при разработке доверенных ПАК для АСУ ОКИИ. ТБ-Форум 2025.
19. Воробьев С. Не навреди, не залечи — киберэтика в сети АСУ ТП. ТБ-Форум 2025.
20. Журнал «Information Security» №4, сентябрь 2025 (спецпроекты SIEM, SOC, IDM, защита сетей).
21. Учебный материал «Планирование работ по ТЗИ», авторский учебный комплект.
...
*Материал поддерживается без привязки к дате конкретного занятия. Перед практической работой проверяйте редакции по официальным источникам: нормативная база КИИ обновляется регулярно.*
