...
SOURCES = [
    dict(id='G24', title='GOST R 56939-2024 · final edition', url='https://protect.gost.ru/gost/details/f3818925-a96f-4f55-96e9-46b44720ee64', note='Foreword, structure, clause 4.7 and planning requirements checked against the local final-edition DOCX/PDF; official record verifies edition dates. English clause wording is a working translation.'),
    dict(id='G16', title='GOST R 56939-2016 · final edition', url='https://protect.gost.ru/gost/details/286a588e-4a6a-4899-88f7-3c370dea1e1d', note='Full local final text checked: NPO Echelon developed the standard; submitted by TC 362; nine groups of measures in 5.1–5.9. Clause 4.2 treats sleduyet as a recommendation. Approved by Rosstandart 2016-06-01; effective 2017-06-01; replaced by the 2024 edition.'),
    ...
    dict(id='MLR', title='Kudriavtseva and Gadyatskaya · A Multivocal Literature Review', url='https://arxiv.org/html/2211.16987v2', note='The user-provided 27-page PDF was read in full: arXiv v2, 4 July 2023, marked In submission. Table II p.5: selected publication dates; pp.6–9, 10–16, 16–23: practices, operating models and evidence limitations. Figure 2 and Table II contain date discrepancies; our timeline labels its dates explicitly.'),
    ...
    dict(id='TRANS', title='Pikov / PVS-Studio · Webinar of 2 July 2025', url='PVS-2025-07-02-lecture.html', note='Full user-supplied working transcript, 00:00:05–02:07:28 (last timestamp, not a measured video duration). Thematic lecture includes timestamp references. Speech recognition is imperfect; historical recollections and participant opinions are distinguished from verified final standards. The supplied recap is not an independent factual source.'),
