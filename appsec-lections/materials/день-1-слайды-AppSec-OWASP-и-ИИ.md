...
### 37. Классы рисков LLM-систем

Риски меняются вместе с архитектурой; список нужен как отправная точка для моделирования угроз.
...
**Главная мысль.** Указывайте версию и дату источника: рекомендации и классификации развиваются.
