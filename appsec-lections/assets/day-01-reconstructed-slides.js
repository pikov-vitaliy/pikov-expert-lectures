...
(() => {
  ...
  const slideNotes = {
    ...
    'ai-system': {
      student: 'Языковая модель не добавляет новых классов уязвимостей. Она добавляет новые входы — и все прежние правила продолжают действовать.',
    ...
    'llm-risks': {
      ...
      teacher: 'Предложите классифицировать три риска систем с моделями по категориям A01–A06. Совпадение почти полное — это лучший аргумент за то, что база не устарела.'
    },
    'ai-supply-chain': {
