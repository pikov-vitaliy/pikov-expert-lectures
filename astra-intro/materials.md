...
## Приложение В. Документация для скачивания

Официальная эксплуатационная документация Astra Linux SE 1.7 (комплект 1.7.5), используемая как первоисточник на занятиях:

- **Руководство администратора, часть 1** — РУСБ.10015‑01 95 01‑1 → `astrafiles/1.7.5_Ruk_admin_1.pdf`
- **Руководство по КСЗ, часть 1** — РУСБ.10015‑01 97 01‑1 → `astrafiles/1.7.5_Ruk_KSZ_1.pdf`
- **Руководство по КСЗ, часть 2** — РУСБ.10015‑01 97 01‑2 → `astrafiles/1.7.5_Ruk_KSZ_2.pdf`

Эти материалы (в формате Markdown) и документацию (PDF) слушатели могут скачать со страницы занятия `astra-intro.pikov.expert`.
