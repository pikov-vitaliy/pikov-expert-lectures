...
*Материал подготовлен для курса ТМ 4.3 «Основы работы и администрирования ОС Astra Linux SE». Автор — В. А. Пиков. Источник фактов — официальная документация Astra Linux SE 1.7 (РУСБ.10015‑01). Версии и реквизиты сертификатов сверяются на дату занятия по `astralinux.ru` и реестру ФСТЭК России.*
