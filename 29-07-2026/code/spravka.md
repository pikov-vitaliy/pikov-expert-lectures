# Учебный код занятия 29.07.2026
...
| `test_student.py` | ПЗ-3 | 13 проверок результата | `py -m unittest -v test_student.py` |
...
Эталон и ключи находятся только в локальном каталоге преподавателя
`_teacher/` и в студенческий архив не включаются.
