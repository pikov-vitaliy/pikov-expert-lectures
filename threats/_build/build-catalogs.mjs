...
for(const page of pageConfigs){
 ...
 const description=page.kind==='excluded'?`${count} угроз вне области анализа самостоятельного ПО: исходный объект воздействия и индивидуальное обоснование исключения. Согласовано с каталогом угроз для ПО.`:`${count} угроз для программного обеспечения: исходный объект воздействия, обоснование и условия применимости. Каталог для работы над моделью угроз в РБПО.`;
